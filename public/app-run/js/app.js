(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["/app-run/js/app"],{
...
var routes = [{
  ...
  component: function component(resolve) {
    return __webpack_require__.e(/*! AMD require */ 0).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(/*! ./pages/Index */ "./resources/js/pages/Index.vue")]; (resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__);}.bind(this)).catch(__webpack_require__.oe);
  },
  name: 'index'
}, {
  path: '*',
  component: function component(resolve) {
    return __webpack_require__.e(/*! AMD require */ 1).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(/*! ./pages/NotFound */ "./resources/js/pages/NotFound.vue")]; (resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__);}.bind(this)).catch(__webpack_require__.oe);
  },
  name: '404'
}];
...
module.exports = __webpack_require__(/*! /Users/quan/Desktop/code/dingtalk/jjd_tcc_admin/resources/js/app.js */"./resources/js/app.js");


/***/ })

},[[0,"/app-run/js/manifest","/app-run/js/vendor"]]]);